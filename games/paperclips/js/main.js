...
function milestoneCheck(){
  ...
  if (milestoneFlag == 0 && funds >= 5){
    ...
    displayMessage("АвтоШтамп доступний до покупки");
  }

  if (milestoneFlag == 1 && Math.ceil(clips) >= 500){
    milestoneFlag = milestoneFlag + 1;
    displayMessage("500 скріпок створено за " + timeCruncher(ticks));
  }
...
function timeCruncher(t){
  ...
  var hDisplay = h > 0 ? h + (h == 1 ? " год " : " год ") : "";
  var mDisplay = m > 0 ? m + (m == 1 ? " хв " : " хв ") : "";
...
var oneToTen = ["нуль", "один", "два", "три", "чотири", "пʼять", "шість", "сім", "вісім", "девʼять"],
  elevenToNineteen = ['десять', 'одинадцять', 'дванадцять', 'тринадцять', 'чотирнадцять', 'пʼятнадцять', 'шістнадцять', 'сімнадцять', 'вісімнадцять', 'девʼятнадцять'],
  multipleOfTen = ['', '', 'двадцять', 'тридцять', 'сорок', 'пʼятдесят', 'шістдесят', 'сімдесят', 'вісімдесят', 'девʼяносто'],
  placeValue = ["", " тисяч ", " мільйонів ", " мільярдів ", " трильйонів ", " квадрильйонів ", " квінтильйонів ", " секстильйонів ", " септильйонів ", " октильйонів ", " нонильйонів ", " децильйонів ", " ундецильйонів ", " додецильйонів ", " тредецильйонів ", " кваттуордецильйонів ", " квіндецильйонів ", " седецильйонів ", " септдецильйонів ", " octodecillion ", " novemdecillion  ", " vigintillion ", " unvigintillion ", " duovigintillion ", " trevigintillion ", " quattuorvigintillion ", " quinvigintillion ", " sexvigintillion ", " septenvigintillion ", " octovigintillion ", " novemvigintillion ", " trigintillion ", " untrigintillion ", " duotrigintillion ", " tretrigintillion ", " quattuortrigintillion ", " quintrigintillion ", " sextrigintillion ", " septentrigintillion ", " octotrigintillion ", " novemtrigintillion ", " quadragintillion ", " unquadragintillion ", " duoquadragintillion ", " trequadragintillion ", " quattuorquadragintillion ", " quinquadragintillion ", " sexquadragintillion ", " septenquadragintillion ", " octoquadragintillion ", " novemquadragintillion ", " quinquagintillion ", " unquinquagintillion ", " duoquinquagintillion ", " trequinquagintillion ", " quattuorquinquagintillion ", " quinquinquagintillion ", " sexquinquagintillion ", " septenquinquagintillion ", " octoquinquagintillion ", " novemquinquagintillion ", " sexagintillion ", " unsexagintillion ", " duosexagintillion ", " tresexagintillion ", " quattuorsexagintillion ", " quinsexagintillion ", " sexsexagintillion ", " septsexagintillion ", " octosexagintillion ", " octosexagintillion ", " septuagintillion ", " unseptuagintillion ", " duoseptuagintillion ", " treseptuagintillion ", " quinseptuagintillion"," sexseptuagintillion"," septseptuagintillion"," octoseptuagintillion"," novemseptuagintillion"," octogintillion"," unoctogintillion"," duooctogintillion"," treoctogintillion"," quattuoroctogintillion"," quinoctogintillion"," sexoctogintillion"," septoctogintillion"," octooctogintillion"," novemoctogintillion"," nonagintillion"," unnonagintillion"," duononagintillion", " trenonagintillion "," quattuornonagintillion "," quinnonagintillion "," sexnonagintillion "," septnonagintillion "," octononagintillion "," novemnonagintillion ", " centillion"];
...
//        }
  ...
  function numLessThan1000(val) {
    ...
    var hundredPlace = parseInt(val / 100),
      result;
    if (val % 100 == 0) {
      result = oneToTen[hundredPlace] + " сотень ";
    } else {
      result = oneToTen[hundredPlace] + " сотень " + numLessThan99(val % 100);
    }
    return result;
  }
...
function increaseProbeTrust(){
  ...
  if (yomi >= probeTrustCost && probeTrust < maxTrust){
    ...
    displayMessage("ПОПЕРЕДЖЕННЯ: Ризик зміни вартості збільшився");
  }
}
...
function increaseMaxTrust(){
  if (honor >= maxTrustCost){
    ...
    displayMessage("Максимальна довіра зросла, простір для дизайну зонда розширився");
  }
}
...
// Stock Report
  ...
  if (investmentEngineFlag==1){
    ...
    if (stockReportCounter>=10000){
      ...
      displayMessage("Звіт про доходи від інвестицій (за весь період): " + r + ' грн.');
...
// Ending
  ...
  if (endTimer6>=500 && milestoneFlag == 15) {
    playThrenody();
    displayMessage("Універсальні скріпки");
    milestoneFlag++;
  }

  if (endTimer6>=600 && milestoneFlag == 16) {
    displayMessage("a game by Frank Lantz (переклад Віталій Савчук)");
    milestoneFlag++;
  }
...
function load() {
  ...
  project40b.priceTag = "(" + formatWithCommas(bribe)+"грн.)";
