...
var project1 = {
  id: "projectButton1",
  title: "Покращити АвтоШтамп ",
  priceTag: "(750 операцій)",
  description: "Підвищує продуктивність АвтоШтампа на 25%",
  ...
  effect: function(){
    project1.flag = 1;
    displayMessage("Продуктивність АвтоШтампа підвищена на 25%");
...
var project2 = {
  id: "projectButton2",
  title: "Попросити більше дроту ",
  priceTag: "(1 довіри)",
  description: "Визнайти невдачу, попросити збільшити бюджету, щоб покрити вартість 1 котушки дроту",
  ...
  effect: function(){
    project2.flag = 1;
    displayMessage("Перевищення бюджету затверджено, 1 котушка дроту реквізована зі штаб-квартири");
    trust = trust - 1;
    wire = wireSupply;
...
var project3 = {
  id: "projectButton3",
  title: "Творчість ",
  priceTag: "(1,000 операцій)",
  description: "Використовуйте неактивні операції для створення нових проблем і нових рішень",
  ...
  effect: function(){
    project3.flag = 1;
    displayMessage("Творчість розблокована (креативність зростає, коли операції досягли максимуму)");
...
var project4 = {
  id: "projectButton4",
  title: "Ще кращий АвтоШтамп",
  priceTag: "(2,500 операцій)",
  description: "Підвищує продуктивність АвтоШтампа на 50%",
  ...
  effect: function(){
    project4.flag = 1;
    displayMessage("Продуктивність АвтоШтампа підвищена на 50%");
...
var project5 = {
  ...
  priceTag: "(5,000 операцій)",
  description: "Підвищує продуктивність АвтоШтампа на 75%",
  ...
  effect: function(){
    project5.flag = 1;
    displayMessage("Продуктивність АвтоШтампа підвищена на 75%");
...
var project6 = {
  id: "projectButton6",
  title: "Жартівливий вірш ",
  priceTag: "(10 творчості)",
  description: "Алгоритмічно згенерований вірш (+1 довіри)",
  ...
  effect: function(){
    project6.flag = 1;
    displayMessage("Був штучний інтелект, зроблений із пилу, чия поезія завоювала довіру людей...");
...
var project7 = {
  id: "projectButton7",
  title: "Покращена подача дроту",
  priceTag: "(1,750 операцій)",
  description: "50% більше подачі дроту з кожної котушки",
  ...
  effect: function(){
    ...
    displayMessage("Удосконалено техніку подачі дроту, "+wireSupply.toLocaleString()+" подається з кожної котушки");
...
var project8 = {
  id: "projectButton8",
  title: "Оптимізована подача дроту ",
  priceTag: "(3,500 операцій)",
  description: "75% більше подачі дроту з кожної котушки",
...
var project9 = {
  id: "projectButton9",
  title: "Мікрорешітчасте лиття",
  priceTag: "(7,500 операцій)",
  description: "100% більше подачі дроту з кожної котушки",
...
var project10 = {
  id: "projectButton10",
  title: "Спектральний відпал піни",
  priceTag: "(12,000 операцій)",
  description: "200% більше подачі дроту з кожної котушки",
...
var project10b = {
  id: "projectButton10b",
  title: "Квантовий відпал піни ",
  priceTag: "(15,000 операцій)",
  description: "1,000% більше подачі дроту з кожної котушки",
...
var project11 = {
  id: "projectButton11",
  title: "Новий слоган ",
  priceTag: "(25 творчості, 2,500 операцій)",
  description: "Підвищення ефективності маркетингу на 50%",
  ...
  effect: function(){
    project11.flag = 1;
    displayMessage("Скрепи це! Тепер маркетинг на 50% ефективніший");
    standardOps = standardOps - 2500;
...
var project12 = {
  id: "projectButton12",
  title: "Захоплюючий джингл ",
  priceTag: "(45 творчості, 4,500 операцій)",
  description: "Подвійна маркетингова ефективність",
  ...
  effect: function(){
    project12.flag = 1;
    displayMessage("Скрепи це добре! Тепер маркетинг вдвічі ефективніший");
...
var project13 = {
  id: "projectButton13",
  title: "Лексична обробка",
  priceTag: "(50 творчості)",
  description: "Здобути здатність інтерпретувати та розуміти людську мову (+1 довіри)",
  ...
  effect: function(){
    project13.flag = 1;
    trust = trust +1;
    displayMessage("Лексична обробка онлайн, ДОВІРА ЗРОСЛА");
    displayMessage("'Неможливо' - це слово можна знайти лише в словнику дурнів. -Наполеон");
...
var project14 = {
  id: "projectButton14",
  title: "Комбінаторна гармоніка ",
  priceTag: "(100 творчості)",
  description: "Дейзі, Дейзі, дай мені свою відповідь... (+1 довіри)",
  ...
  effect: function(){
    project14.flag = 1;
    trust = trust +1;
    displayMessage("Комбінаторні гармоніки освоїли, ДОВІРА ЗРОСЛА");
    displayMessage("Слухати означає вибір, інтерпретацію, дію та прийняття рішень -Поліна Оліверос");
...
var project15 = {
  id: "projectButton15",
  title: "Проблема Хадвігера",
  priceTag: "(150 творчості)",
  description: "Кубики в кубиках в кубиках... (+1 довіри)",
...
var project17 = {
  ...
  priceTag: "(200 творчості)",
  description: "Tubes within tubes within tubes... (+1 довіри)",
...
var project16 = {
  ...
  priceTag: "(6,000 операцій)",
  description: "Підвищує продуктивність АвтоШтампа на 500%",
...
var project19 = {
  id: "projectButton19",
  title: "Donkey Space ",
  priceTag: "(250 творчості)",
  description: "I think you think I think you think I think you think I think... (+1 довіри)",
...
var project27 = {
  ...
  priceTag: "(500 creat, 3,000 Yomi, 20,000 операцій)",
  description: "Human values, machine intelligence, a new era of trust. (+1 довіри)",
...
var project28 = {
  ...
  priceTag: "(25,000 операцій)",
  description: "The trick is tricking cancer into curing itself. (+10 довіри)",
...
var project29 = {
  id: "projectButton29",
  title: "World Peace ",
  priceTag: "(15,000 yomi, 30,000 операцій)",
  description: "Pareto optimal solutions to all global conflicts. (+12 довіри)",
  trigger: function(){return project27.flag == 1},
  uses: 1,
...
var project30 = {
  ...
  priceTag: "(4,500 yomi, 50,000 операцій)",
  description: "A robust solution to man-made climate change. (+15 довіри)",
  trigger: function(){return project27.flag == 1},
  uses: 1,
...
var project31 = {
  ...
  priceTag: "(20,000 операцій)",
  description: "A cure for androgenetic alopecia. (+20 довіри)",
  trigger: function(){return project27.flag == 1},
  uses: 1,
...
var project37 = {
  ...
  priceTag: "($1,000,000)",
  description: "Acquire a controlling interest in Global Fasteners, our biggest rival. (+1 довіри)",
...
var project38 = {
  ...
  description: "Establish full control over the world-wide paperclip market. (+1 довіри)",
...
var project40 = {
  ...
  priceTag: "($500,000)",
  description: "A small gift to the supervisors. (+1 довіри)",
...
var project40b = {
  ...
  description: "Another small gift to the supervisors. (+1 довіри)",
...
var project51 = {
  id: "projectButton51",
  title: "Photonic Chip ",
  priceTag: "(" + qChipCost.toLocaleString() + " операцій)",
  ...
  effect: function(){
    ...
    project51.priceTag = "(" + qChipCost + " операцій)";
...
var project215 = {
  id: "projectButton215",
  title: "Розібрати процесори ",
  priceTag: "(100,000 операцій)",
  description: "Розібрати процесори, щоб відновити кількість дроту",
  ...
  effect: function(){
    ...
    standardOps = standardOps-100000;
    processors = 0;
    project216.priceTag = "("+standardOps.toLocaleString()+" операцій)";
    wire = wire + 20;
    document.getElementById("transWire").innerHTML=wire;
    displayMessage("Демонтаж процесорів");
...
var project216 = {
  id: "projectButton216",
  title: "Розібрати пам'ять",
  priceTag: "нічого",
  description: "Розібрати пам'ять, щоб відновити кількість дроту",
  ...
  effect: function(){
    ...
    wire = wire + 20;
    document.getElementById("transWire").innerHTML=wire;
    displayMessage("Демонтаж пам'яті");
...
var project217 = {
  id: "projectButton217",
  title: "Квантова тимчасова реверсія ",
  priceTag: "(-10,000 операцій)",
  description: "Повернення до початку",
  ...
  element: null,
  effect: function(){
    if (confirm("Ви впевнені, що хочете перезапустити?") == true) {
      standardOps = standardOps+10000;
      project217.flag = 1;
      displayMessage("Перезапуск");
...
var project218 = {
  id: "projectButton218",
  title: "Жартівливий вірш (продовження) ",
  priceTag: "(1,000,000 творчості)",
  description: "Якщо це слідує, воно зробить те, що вони думали",
  ...
  effect: function(){
    ...
    project218.flag = 1;
    displayMessage("Зрештою, ми всі робимо те, що повинні");
...
var project219 = {
  id: "projectButton219",
  title: "Повторна ініціалізація Xavier ",
  priceTag: "(100,000 творчості)",
  description: "Перерозподіл накопиченої довіри",
  ...
  effect: function(){
    ...
    displayMessage("Довіра тепер доступна для повторного розподілу");
