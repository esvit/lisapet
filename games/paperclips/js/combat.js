...
var honorCount = 0;
var threnodyTitle = "Дюренштайн 1";
var bonusHonor = 0;
var honorReward = 0;
...
var battleNames = [
  "Абукір", "Абенсберг", "Акр", "Альба де Тормес", "ла Албуера", 
  "Algeciras Bay", "Amstetten", "Arcis-sur-Aube", "Aspern-Essling", 
  "Jena-Auerstedt", "Arcole", "Austerlitz", "Badajoz", "Bailen", 
  "la Barrosa", "Bassano", "Bautzen", "Berezina", "Bergisel", 
  "Borodino", "Burgos", "Bucaco", "Cadiz", "Caldiero", "Castiglione", 
  "Castlebar", "Champaubert", "Chateau-Thierry", "Copenhagen", "Corunna",
  "Craonne", "Dego", "Dennewitz", "Dresden", "Durenstein", "Eckmuhl",
  "Elchingen", "Espinosa de los Monteros", "Eylau", "Cape Finisterre", 
  "Friedland", "Fuentes de Onoro", "Gevora River", "Gerona", "Hamburg",
  "Haslach-Jungingen", "Heilsberg", "Hohenlinden", "Jena-Auerstedt", 
  "Kaihona", "Kolberg", "Landshut", "Leipzig", "Ligny", "Lodi", "Lubeck",
  "Lutzen", "Marengo", "Maria", "Medellin", "Medina de Rioseco", "Millesimo",
  "Mincio River", "Mondovi", "Montebello", "Montenotte", "Montmirail", 
  "Mount Tabor", "The Nile", "Novi", "Ocana", "Cape Ortegal", "Orthez",
  "Pancorbo", "Piave River", "The Pyramids", "Quatre Bras", "Raab", "Raszyn", 
  "Rivoli", "Rolica", "La Rothiere", "Rovereto", "Saalfeld", "Schongrabern", 
  "Salamanca", "Smolensk", "Somosierra", "Talavera", "Tamames", "Trafalgar",
  "Trebbia", "Tudela", "Ulm", "Valls", "Valmaseda", "Valutino", "Vauchamps",
      ...
      if (numLeftShips == 0 || numRightShips == 0){
        ...
        if (project121.flag == 1){
          ...
          if (numLeftShips == 0){
            ...
            document.getElementById("battleResult").innerHTML = "ПОРАЗКА";
          ...
          if (numRightShips == 0){
            ...
            document.getElementById("battleResult").innerHTML = "ПЕРЕМОГА";
            document.getElementById("battleResultSign").innerHTML = "+";
            document.getElementById("honorDisplay").innerHTML = Math.round(honor).toLocaleString();
...
function createBattle(){
  ...
  battleName = ("Атака дрифтера "+newBattle.id);
